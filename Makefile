SRC		=	minishell.c parsing/expand_utils2.c parsing/prompt_utils.c parsing/token_utils.c parsing/token_utils3.c \
			...
			parsing/.print.c parsing/parse_token.c parsing/syntaxe_error.c parsing/token_utils2.c parsing/expand_here_doc.c \
			...
			execution/cmd/here_doc.c execution/cmds/ft_pipe.c  execution/cmds/ft_and.c execution/cmds/ft_or.c \
