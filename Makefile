SRC		=	minishell.c parsing/expand_utils2.c parsing/prompt_utils.c parsing/token_utils.c parsing/token_utils3.c parsing/wildcard.c \
			...
			parsing/redirections.c parsing/redirect_utils.c parsing/parse_pipes.c parsing/expand_utils.c parsing/expand_files.c \
			parsing/parse_token.c parsing/syntaxe_error.c parsing/token_utils2.c parsing/expand_here_doc.c parsing/wildcard_utils.c \
