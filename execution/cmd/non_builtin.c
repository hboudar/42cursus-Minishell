...
/*   Updated: 2024/06/04 21:21:03 by hboudar          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../execution.h"

static int  non_outredirect(t_prompt *prompt, int *fd, int *fd1)
{
...
static int	non_inredirect(t_prompt *prompt, int *fd, int *fd0)
{
